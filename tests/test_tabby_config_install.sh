...
assert_file_contains "$SHORTCUT_GUIDE" '### 9.1 Tabby 配置参考'
assert_file_contains "$SHORTCUT_GUIDE" '- 本机来源：`~/.config/tabby/config.yaml`'
assert_file_contains "$SHORTCUT_GUIDE" '- 仓库公开快照：`config/tabby/config.yaml`'
